# Generated by Powerlevel10k configuration wizard on 2020-03-06 at 10:26 CET.
...
function prompt_svn() {
    if ! zstat -A size +size .svn 2>/dev/null; then
      # No '.svn' folder in the current directory.
      return
    fi

    p10k segment -f "#89e051" -t "$(svn_current_branch_name)"
}
